...
class DioClient {
  ...
  DioClient(this.baseUrl,
    ...
    dio
      ...
      ..options.headers = {
        ...
        AppConstants.langKey : countryCode == 'SN'? 'fr':countryCode!.toLowerCase(),
  ...
  void updateHeader(String? token, String? countryCode) {
    ...
    countryCode = countryCode == null ? this.countryCode == 'SN' ? 'fr': this.countryCode!.toLowerCase(): countryCode == 'US' ? 'en' : countryCode.toLowerCase();
    this.token = token;
